...
public class Discord : Node
{
	...
	public string applicationId = "829283026110119966";
	...
	public void UpdatePresence()
	{
		...
		presence.smallImageText = small_icon_desc;
...
{
	const string path = "modules/discord-rpc.dll";
	...
	public static void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId)
	{
		...
		DiscordRPC.Button test = new DiscordRPC.Button();
		test.Label = "test";
