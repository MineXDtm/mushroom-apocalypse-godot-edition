...
func _on_buy_pressed():
	Console.write_line(nedded1)
	if nedded2 != null and not Player.check_for_item(nedded1 ,needed_number1 ):return
	Console.write_line("test")
	if nedded1 != null and not Player.check_for_item(nedded2 ,needed_number2):return
