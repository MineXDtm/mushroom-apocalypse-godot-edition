...
func _on_buy_pressed():
	for item in PlayerInventory.inventory1:
		...
		for item2 in PlayerInventory.inventory1:
			...
			if PlayerInventory.inventory1[item][0] == "drop_wood" and PlayerInventory.inventory1[item][1] >= 1 and PlayerInventory.inventory1[item2][0] == "coal" and PlayerInventory.inventory1[item2][1] >= 1:
				...
				PlayerInventory.add_item("torch", 4)
				return
				...
				for item3 in PlayerInventory.inventory:
					if PlayerInventory.inventory[item3][0] == "coal" and PlayerInventory.inventory[item3][1] >= 1:
						PlayerInventory.inventory1[item][1] -= 1
	...
	for item in PlayerInventory.inventory:
		for item2 in PlayerInventory.inventory:
			if PlayerInventory.inventory[item][0] == "drop_wood" and PlayerInventory.inventory[item][1] >= 1 and PlayerInventory.inventory[item2][0] == "coal" and PlayerInventory.inventory[item2][1] >= 1:
